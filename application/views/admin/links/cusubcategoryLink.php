  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Subject To Subject Category Link</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<? echo base_url("admin/dashboard") ?>">Home</a></li>
              <li class="breadcrumb-item"><a href="<? echo base_url("admin/links/subcategoryLinks") ?>">Subject To Subject Category Links</a></li>
        	...
        	<div class="col-md-12">
				<div class="card card-primary card-outline">
					<div class="card-header">
						<h3 class="card-title"><? echo ($id != "") ? 'Update' : 'Create'; ?> Subject To Subject Category Link</h3>
					</div>
					<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
									  ...
									  <select class="duallistbox" multiple="multiple" name="subjects[]" style="height: 200px !important;">
										<? 
										  	$subjects = $this->db->order_by("id","desc")->get_where("tbl_subjects",["deleted"=>0])->result(); 
										  	foreach($subjects as $subject){
												
												$sel = '';
												if(in_array($subject->id,$sel_subjects)){
													$sel = 'selected';
												}
												
												echo '<option value="'.$subject->id.'" '.$sel.'>'.$subject->subject_name.'</option>';
											}
										 ?>
									  </select>
									</div>
								...
								<div class="col-md-6">
									<div class="form-group">
									  ...
									  <select class="form-control select2bs4" name="subject_category" required style="width: 100%;">
										<option value="">Select Subject Category</option>
										<? 
										  	$scats = $this->db->order_by("id","desc")->get_where("tbl_subject_category",["deleted"=>0])->result(); 
										  	foreach($scats as $scat){
												$sel = ($id == $scat->id) ? 'selected' : '';
												echo '<option value="'.$scat->id.'" '.$sel.'>'.$scat->category_name.'</option>';
											}
										 ?>
									  </select>
									</div>
