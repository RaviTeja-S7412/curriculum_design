      ...
      <div class="container-fluid">
        	...
        	<div class="col-md-12">
				<div class="card card-primary card-outline">
					<div class="card-header">
						<h3 class="card-title"><? echo ($id != "") ? 'Update' : 'Create'; ?> Subject Category</h3>
					</div>
					<div class="card-body">
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" name="category_name" required class="form-control" id="exampleInputEmail1" placeholder="Enter Subject Category Name" value="<? echo $pdata->category_name ?>">
									</div>
								</div>
								<div class="col-md-2">
        ...
        <div class="row">
         	<div class="col-12">
        		...
        		<div class="card card-primary card-outline">
				  <div class="card-header">
					<h3 class="card-title">All Subject Categories</h3>
				  </div>
				  <!-- /.card-header -->
				  <div class="card-body">
					<table id="example1" class="table table-bordered table-hover">
					  ...
					  <tbody>
						  <? $data = $this->db->order_by("id","desc")->get_where("tbl_subject_category",["deleted"=>0])->result(); 
						  		$i = 1;
								foreach($data as $d){
						  ?>
							  <tr>
								...
								<td>
									<a href="<? echo base_url('admin/settings/Subcategories/index/').$d->id ?>"><i class="fa fa-marker"></i></a>&nbsp;&nbsp;
...
<script>
		...
		.then((willDelete) => {
		  if (willDelete) {
			  	...
			  	$.ajax({
					...
					data : {id:id},
					dataType: "json",
					url : "<? echo base_url('apis/SubCategory/delete') ?>",
	...
	$("#cprogram").submit(function(e){
		...
		$.ajax({
			...
			data : fdata,
			dataType: "json",
			url : "<? echo base_url('apis/SubCategory/create') ?>",
			success : function(data){
